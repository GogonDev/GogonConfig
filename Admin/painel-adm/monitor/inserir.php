...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO produtos SET nome = :nome, modelo = :modelo, marca = :marca, categoria = :categoria, descri = :descricao, img = '$imagem'");	
}else{
	if(@$_FILES['imagem']['name'] == ""){
